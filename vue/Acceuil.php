    ...
    <br>
       ...
       <?php if(isset($articleList)):
        ...
        <div  class="container-fluid">
            <div class="row">
                <div class="card offset-1" style="width: 40rem;">
                    <div class="card-header"><h5><strong><?=$article->getTitre();?></strong></h5></div>
                        <label>Auteur : <?=$article->getPrenomAuteur()." ".$article->getNomAuteur();?></label>
                        <label>Date : <?=$article->getDate();?></label>
                    <form class="card-body" method="post">
